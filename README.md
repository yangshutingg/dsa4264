...
│   ├── trend_analysis.ipynb       # Requires topics_2020.csv, topics_2021.csv, topics_2022.csv, topics_2023.csv, combined_data_scores.csv, generates monthly_scores_summary.csv
├── .gitignore              
├── README.md                
```
